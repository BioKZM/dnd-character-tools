...
**_Spell Lists._** [Druid](http://dnd5e.wikidot.com/spells:druid), [Warlock](http://dnd5e.wikidot.com/spells:warlock)
...
[Dispel Magic](http://dnd5e.wikidot.com/spell:dispel-magic) or a similar effect successfully applied to the sapphire ends this spell’s effect.
...
You invoke the spirits of nature to protect an area outdoors or underground. The area can be as small as a 30-foot cube or as large as a 90-foot cube. Buildings and other structures are excluded from the affected area. If you cast this spell in the same area every day for a year, the spell lasts until dispelled. The spell creates the following effects within the area. When you cast this spell, you can specify creatures as friends who are immune to the effects. You can also specify a password that, when spoken aloud, makes the speaker immune to these effects. The entire warded area radiates magic. A [dispel magic](https://dnd5e.wikidot.com/spell:dispel-magic) cast on the area, if successful, removes only one of the following effects, not the entire area. That spell’s caster chooses which effect to end. Only when all its effects are gone is this spell dispelled.

**Solid Fog.** You can fill any number of 5-foot squares on the ground with thick fog, making them heavily obscured. The fog reaches 10 feet high. In addition, every foot of movement through the fog costs 2 extra feet. To a creature immune to this effect, the fog obscures nothing and looks like soft mist, with motes of green light floating in the air.

**Grasping Undergrowth.** You can fill any number of 5-foot squares on the ground that aren’t filled with fog with grasping weeds and vines, as if they were affected by an [entangle](https://dnd5e.wikidot.com/spell:entangle) spell. To a creature immune to this effect, the weeds and vines feel soft and reshape themselves to serve as temporary seats or beds.
...
- A constant [gust of wind](https://dnd5e.wikidot.com/spell:gust-of-wind) in two locations of your choice

- [Spike growth](https://dnd5e.wikidot.com/spell:spike-growth) in one location of your choice

- [Wind wall](https://dnd5e.wikidot.com/spell:wind-wall) in two locations of your choice
...
**_Spell Lists._** [Druid (Optional)](https://dnd5e.wikidot.com/spells:druid), [Sorcerer (Optional)](https://dnd5e.wikidot.com/spells:sorcerer), [Warlock](http://dnd5e.wikidot.com/spells:warlock), [Wizard](http://dnd5e.wikidot.com/spells:wizard)
...
- **Doors.** All doors in the warded area are magically locked, as if sealed by an [Arcane Lock](http://dnd5e.wikidot.com/spell:arcane-lock) spell. In addition, you can cover up to ten doors with an illusion (equivalent to the illusory object function of the [Minor Illusion](http://dnd5e.wikidot.com/spell:minor-illusion) spell) to make them appear as plain sections of wall.

- **Stairs.** Webs fill all stairs in the warded area from top to bottom, as the [Web](http://dnd5e.wikidot.com/spell:web) spell. These strands regrow in 10 minutes if they are burned or torn away while Guards and Wards lasts.

- **Other Spell Effect.** You can place your choice of one of the following magical effects within the warded area of the stronghold.
    - Place [Dancing Lights](http://dnd5e.wikidot.com/spell:dancing-lights) in four corridors. You can designate a simple program that the lights repeat as long as Guards and Wards lasts.
    - Place [Magic Mouth](http://dnd5e.wikidot.com/spell:magic-mouth) in two locations.
    - Place [Stinking Cloud](http://dnd5e.wikidot.com/spell:stinking-cloud) in two locations. The vapors appear in the places you designate; they return within 10 minutes if dispersed by wind while Guards and Wards lasts.
    - Place a constant [Gust of Wind](http://dnd5e.wikidot.com/spell:gust-of-wind) in one corridor or room.
    - Place a [Suggestion](http://dnd5e.wikidot.com/spell:suggestion) in one location. You select an area of up to 5 feet square, and any creature that enters or passes through the area receives the Suggestion mentally.
...
**_Spell Lists._** [Cleric](http://dnd5e.wikidot.com/spells:cleric), [Druid](http://dnd5e.wikidot.com/spells:druid)
...
**_Spell Lists._** [Bard (Optional)](https://dnd5e.wikidot.com/spells:bard), [Cleric](http://dnd5e.wikidot.com/spells:cleric), [Druid](http://dnd5e.wikidot.com/spells:druid)
...
**_Spell Lists._** [Sorcerer (Optional)](https://dnd5e.wikidot.com/spells:sorcerer), [Wizard](http://dnd5e.wikidot.com/spells:wizard)
...
A creature that can see the sensor (such as one using _[see invisibility](https://dnd5e.wikidot.com/spell:see-invisibility)_ or truesight) sees a translucent image of the tormented humanoid whose soul you caged.
...
**_Spell Lists._** [Cleric (Optional)](https://dnd5e.wikidot.com/spells:cleric), [Druid](http://dnd5e.wikidot.com/spells:druid), [Sorcerer](http://dnd5e.wikidot.com/spells:sorcerer), [Wizard](http://dnd5e.wikidot.com/spells:wizard)
...
**_Spell Lists._** [Sorcerer (Optional)](https://dnd5e.wikidot.com/spells:sorcerer), [Warlock (Optional)](https://dnd5e.wikidot.com/spells:warlock), [Wizard (Optional)](https://dnd5e.wikidot.com/spells:wizard)
